...
\textbf{Ne pas confondre le caractère 4 avec le nombre 4 suivant
l'usage, Python c'est faire la différence !}
...
\end{tcolorbox}
    ...
    Exercice 3 Compléter le code ci-dessous pour échanger les valeurs des
variables a et b, puis les afficher. Par exemple lorsque \(a=10\) et
\(b=15\) l'affichage final doit être 15 pour \(a\) et 10 pour \(b\). \faExclamationTriangle\
Cela doit fonctionner quelles que soient les valeurs de \(a\) et \(b\).
